...
def ShowNearest(fea,cluster_centers_,n_clusters,attribute_type,method_type):
    ...
    :param fea: 特征向量
    :param cluster_centers_: 聚类中心
    :param n_clusters:每个流派的聚类数量
...
def get_fea(methodtype):
    ...
    mfTwoLayer = HSRx2main.HSRtest(n_epochs_nmf=100, n_epochs_wnmf=100, lamda_wnmf=18, gama=1, beta=10, type='tanh')
    mfTwoLayer.Loaddata()
    mfTwoLayer.Setparamets(M=[20,100], N=[20,1000], lamda=15, n_epochs=100, alpha=0.5)
